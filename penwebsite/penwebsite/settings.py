"""
Django settings for penwebsite project.
...
SECRET_KEY = '&aetxasunh*oq3gf7tahulaen6yf-hz+tx+3cpr)&gw3l6fias'
...
WSGI_APPLICATION = 'penwebsite.wsgi.application'
