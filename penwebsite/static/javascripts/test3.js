...
document.getElementById('sumbit_order_page').onmouseenter = function(){

        document.getElementById('sumbit_order_page').style.backgroundColor = 'green'
}

document.getElementById('sumbit_order_page').onmouseleave = function(){

        document.getElementById('sumbit_order_page').style.backgroundColor = 'orange'
}
